...
public class ComparatorExampleList {
    ...
    public static void main(String[] args) {
        ...
        estudantes.add(new Estudante("Maisa", 27));
        estudantes.add(new Estudante("Willian", 39));
        estudantes.add(new Estudante("Jaqueline", 24));
        estudantes.add(new Estudante("Moisés", 45));
